...
This library can be used in conjunction with the [Bonsai Foundry Template]. The Ethereum Contract that validates the Groth16 proof must also validate the `EvmEnv` commitment. This commitment is the ABI-encoded bytes of the following type:
