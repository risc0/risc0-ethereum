...
[RISC Zero] is a zero-knowledge verifiable general computing platform, with support for integration with [Ethereum].
...
RISC Zero's Ethereum contracts can be found in the [contracts] directory.
...
Source code for the rely is in the [relay] directory.
