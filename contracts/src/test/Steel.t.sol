...
contract SteelTest is Test {
    ...
    function test_ValidateCommitment_V2_Reverts_InvalidCommitmentVersion() public {
        uint240 claimID = 999;
        // On release-1.2, validateCommitment treats any version != 0/1 as InvalidCommitmentVersion;
        // the version-2 ConsensusSlotCommitmentNotSupported error is only present from release-1.3+.
